        ...
        >
          ...
          >
            <template #item="{ element }">
              <StructElemReportItem :struct-elem="element" class="drag-handle" />
            </template>
          </draggable>
        </div>
      </q-card>
...
import StructElemReportItem from './StructElemReportItem.vue'

const { moveStructElem } = useFinishingReportService()
