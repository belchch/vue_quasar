...
const { updateFloorSectionMeasurement, updateCeilSectionMeasurement, updateWallSectionMeasurement, updateOpeningMeasurement } = useMeasurementService()
const materialStore = useMaterialStore()


const { value, row, canEdit = true, block, } = defineProps<{
    value: string | number | undefined,
    block: 'floor_section' | 'ceil_section' | 'wall_section' | 'opening',
