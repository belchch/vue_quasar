      ...
      <q-list>
        ...
        >
          <q-list>
            ...
            <div class="add-inspection-btn" v-if="hasPermission(['inspection.update'])">
              <q-btn size="xs" color="primary" outline @click="createInspectionOpen = true"
                >добавить осмотр</q-btn
              >
            </div>
          </q-list>
        </q-expansion-item>
